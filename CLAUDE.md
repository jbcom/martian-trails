...
- **Playtest:** prefer the integrated browser, Vitest browser, and Playwright for reproducible local screenshots across target viewports. Use an external browser only when the compatibility target or the user explicitly calls for it.
