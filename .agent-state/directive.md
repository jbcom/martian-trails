...
- [x] m8-1 Encounter engine + Trader vertical slice [done — schema+resolver+content+AI(yuka Vehicle/Arrive)+run wiring+EncounterScene+EncounterPanel(Imagen portrait)+screen; Safari-verified Vasquez encounter (in-scene NPC + portrait + trade→resume); 277 unit/29 browser green; commits 9887c65..6b90ac9]
