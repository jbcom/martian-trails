...
- [ ] [ACTIVE] m8-final Definition of done: full green; each slice browser-verified w/ screenshots read; docs/ENCOUNTERS.md current; encounters demonstrably replace the giant dialogue boxes; PR for M8.
  ...
  - Remaining publication step: stage/commit, push `feat/m8-encounters`, open M8 PR, then address any new PR review feedback.
