...
- [ ] [WAIT] m8-research 3 research agents running (yuka capabilities, agofa dialogue/NPC pipeline, MECC trail games + diegetic NPC design). Synthesize → docs/ENCOUNTERS.md + concrete m8 items.
